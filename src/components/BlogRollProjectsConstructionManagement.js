...
const BlogRollProjectsConstructionManagement = ( {data} ) => {
...
BlogRollProjectsConstructionManagement.propTypes = {
...
export default () => (
  <StaticQuery
    query={graphql`
      query BlogRollProjectsConstructionManagementQuery {
        allMarkdownRemark(
          sort: { order: DESC, fields: [frontmatter___date] }
          filter: { frontmatter: {featuredprojects: {eq: true}, category: {eq: "construction-management"} } }
        ) {
          edges {
            node {
    ...
    `}
    render={(data, count) => <BlogRollProjectsConstructionManagement data={data} count={count} />}
  />
)
