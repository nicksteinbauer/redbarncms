...
import BlogRollProjectsConstructionManagement from '../../components/BlogRollProjectsConstructionManagement'
        ...
        <div className="projects projects-page">
          <div className="projects-banner align-vertical">
            ...
            <div className="callto-content inside-xxl">
              ...
              <h1>Construction Management Projects</h1>
            </div>
            
          </div>
          <section className="projects-section section sec-black p-lot">
            <div className="inside-xxl">
              <BlogRollProjectsConstructionManagement />
            </div>
          </section>
        </div>
      </Layout>
