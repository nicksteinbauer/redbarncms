...
import CellTower from "../img/RedBarn-Homepage-new.mp4"
  ...
  <div className="the-rest">
    <div className="callto align-vertical">
      <div className="callto-content home-callto">
        ...
        <div className="button-container"><Link className="button thirty3" to="https://google.com">Learn More</Link></div>
      </div>
    </div>
